      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto mt-2">
          ...
          <div className="flex">
            <button
              onClick={resetInput}
              className="flex-grow text-gray-500 hover:bg-gray-400 p-3 rounded-lg transition transform duration-500"
            >
              Cancel
            </button>
            <button
              onClick={search}
              className="flex-grow text-red-400 hover:bg-gray-500 p-3 rounded-lg transition transform duration-500"
            >
              Search
            </button>
          </div>
